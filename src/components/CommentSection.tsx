      ...
      {userId ? (
        <div className="bg-card border border-card-border rounded-2xl p-4 mb-6">
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 rounded-lg border border-card-border bg-card text-sm resize-none focus:outline-none focus:ring-2 focus:ring-amber-500 mb-3"
          />
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-amber-600 hover:bg-amber-700 disabled:opacity-50 text-white px-4 py-1.5 rounded-md text-sm font-medium transition"
            >
        ...
        <div className="mb-6 p-4 bg-card rounded-lg text-center text-sm text-muted">
          <a
            href="/auth/login"
